...
const handleClick = event => {
  ...
  alert("Pikachu: 'This App is so Amazing!' ")
}
  ...
  if (user) {
   ...
   width: "50%",
    ...
    filter: "blur(0px)"}}/>
        ...
        <img className="teamgif" onClick={handleClick} src="https://cdn.discordapp.com/attachments/371136521601941504/1011662970973081691/pixel-speech-bubble.png"></img>  
